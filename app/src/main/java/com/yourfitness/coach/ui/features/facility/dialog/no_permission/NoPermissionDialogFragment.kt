...
import com.yourfitness.coach.databinding.DialogNoPermissionBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class NoPermissionDialogFragment : BottomSheetDialogFragment() {

    private val binding: DialogNoPermissionBinding by viewBinding(createMethod = CreateMethod.BIND)
    private val viewModel: NoPermissionViewModel by viewModels()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.dialog_no_permission, container, false)
    }
