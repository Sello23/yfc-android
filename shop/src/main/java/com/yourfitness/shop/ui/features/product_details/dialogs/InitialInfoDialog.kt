...
import com.yourfitness.shop.databinding.DialogInitialInfoBinding
...
@AndroidEntryPoint
class InitialInfoDialog : BaseBottomSheetDialogFragment() {

    override val binding: DialogInitialInfoBinding by viewBinding()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.helperAction.setOnClickListener { navigator.navigate(ShopNavigation.HowToEarnCoins()) }
        val coins = requireArguments().getLong(COINS_COUNT)
